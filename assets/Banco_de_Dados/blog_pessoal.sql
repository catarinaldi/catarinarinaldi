...
-- -----------------------------------------------------
-- Table `db_blog_pessoal`.`tb_educacao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_blog_pessoal`.`tb_educacao` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_tb_educacao_tb_postagens_idx` (`postagens_id` ASC) VISIBLE,
  INDEX `fk_tb_educacao_tb_usuarios1_idx` (`usuario_id` ASC) VISIBLE,
  CONSTRAINT `fk_tb_educacao_tb_postagens`
    FOREIGN KEY (`postagens_id`)
    REFERENCES `db_blog_pessoal`.`tb_postagens` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_educacao_tb_usuarios1`
